...
$conn = oci_connect($user, $pass, $databaseHost);
...
<body oncontextmenu="return false">
	...
	$button1 = filter_var($_POST["user"], FILTER_SANITIZE_STRING);
	$button2 = filter_var($_POST["password"], FILTER_SANITIZE_STRING);
	...
	$query = OCIParse($conn, "select * from USUARIO where usuario='$usuario'  AND clave='$password' order by id");
	OCIExecute($query);
