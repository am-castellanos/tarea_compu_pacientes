...
<h3>   PARA ACTUALIZAR INFORMACION A LA BASE DE DATOS </h3>

<div class="row">

<div class="col">
  <span>INGRESAR ID PARA ACTUALIZAR </span>
...
<input type="submit" class="btn btn-primary" value="HAGA CLIC PARA LLAMAR EL REGISTRO">
</div>
</div>
...
<div class="container w-80">
    ...
    <div class="row">
         ...
         <div class="row pt-3">
                ...
                <input type="submit" class="btn btn-primary" value="haga clic para actualizar el registro">
...
$edad = $_POST['edada'];
 ...
 $actualizar = OCIParse($conexion, " update usuarios set nombres = '$nombre', apellidos = '$apellido', edad='$edad' where id ='$id'    ");
